          ...
          <tbody>
            {applicants.filter(item =>item.jobId && item.userId).map((applicant, index) => (
              <tr key={index} className='text-gray-700'>
                ...
                {/* User Name + Image */}
                <td className='py-2 px-4 border-b flex items-center whitespace-nowrap flex items-center'>
                  <img
                ...
                {/* Job Title */}
                <td className='py-2 px-4 border-b max-sm:hidden whitespace-nowrap'>
                ...
                <td className='py-2 px-4 border-b relative'>
                  ...
                  ? <div className='relative inline-block text-left group'>
                    ...
                    <div className='z-10 hidden absolute right-0 md:left-0 top-0 mt-2 w-32 bg-white border border-gray-200 rounded shadow group-hover:block'>
                      ...
                      <button onClick={()=>changeJobApplicationStatus(applicant._id,'Accepted')} className='block w-full text-left px-4 py-2 text-red-500 hover:bg-gray-100'>
                        Reject
                      </button>
                    </div>
                  </div>
